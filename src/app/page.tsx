    ...
    <main className="flex h-screen w-full bg-slate-50 overflow-hidden relative">
      ...
      <aside className={cn(
        ...
        <div className="flex-1 overflow-hidden relative">
          {selectedPlace ? (
            <div className="absolute inset-0 z-20 bg-white h-full animate-in slide-in-from-right-4 duration-300">
              <PlaceDetails
                place={selectedPlace}
            ...
            <div className="h-full flex flex-col">
              ...
              {!user && places.length > 0 && (
                <div className="mx-5 mb-4 p-4 bg-gradient-to-r from-indigo-500 to-violet-500 rounded-2xl text-white relative overflow-hidden">
                  ...
                  <div className="relative">
                    ...
                    <p className="text-sm text-white/90 mb-3">Join virtual queues and get notified when it&apos;s your turn!</p>
              ...
              {/* Active Ticket Alert */}
              {user && activeTickets.length > 0 && viewMode === "places" && (
                <div
                  onClick={() => setViewMode("tickets")}
                  className="mx-5 mb-4 p-4 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-2xl text-white cursor-pointer hover:shadow-lg transition-all group"
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="font-bold">You&apos;re in a queue!</div>
                        <div className="text-sm text-white/80">Tap to view your ticket</div>
                      </div>
                    </div>
              ...
              {filteredPlaces.length > 0 ? (
                ...
                <div className="flex flex-col items-center justify-center flex-1 text-center p-8">
                  ...
                  <h3 className="font-bold text-slate-700 mb-1">No places found</h3>
